...
#include "C:\Users\Eleonora\Documents\SDL_CodeBlocks\mikrokosmos_codeblocks\rapidxml-1.13\rapidxml.hpp" // mac: add to project, windows: add headers to lib and refrence with < >
#include "Card.h"
...
int main(int argc, char*args[])
{
    ...
    std::string xmlPath = "C:/Users/Eleonora/Documents/SDL_CodeBlocks/mikrokosmos_codeblocks/demo/mediaTest.xml"; // change to correct path
    ...
    if (!initWindow()) {
        ...
        for (int i = 0; i < theCards.size(); i++) {
            ...
            if (!(theCards[i].loadFromRenderedText(gRenderer)))
            {
